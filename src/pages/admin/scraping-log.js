...
export default function AdminScrapingLog() {
  ...
  return (
    <AdminGuard>
      <GeoAgriLayout title="Log Scraping">
        <Head><title>Log Scraping — GeoAgri</title></Head>

        <div className="page-header">
          <h1 className="page-title">Log Scraping</h1>
