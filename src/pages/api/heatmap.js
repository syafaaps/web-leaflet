...
// // Ambil data dari view v_heatmap_kabkot
// // ⚠️ Ganti nama view jika berbeda
// import pool from '../../lib/db';
...
//       conditions.push(`tanggal = (SELECT MAX(tanggal) FROM v_heatmap_kabkot)`);
//     }
...
//     // Ubah ke format GeoJSON FeatureCollection supaya mudah dipakai Leaflet
//     const features = result.rows
//       .filter(row => row.geojson) // skip baris tanpa geom
//       .map(row => ({
//         type: 'Feature',
//         geometry: row.geojson,
//         properties: {
